...
public class CardDealer {
    ...
    private void initMonsterCardDeck(){
        ...
        //unusedMonsters[3]
        badConsequence = new SpecificBadConsequence("Te atrapan para llevarte de fiesta y te dejan caer en mitad del vuelo. Decarta 1 mano visible y 1 mano oculta", 0, new ArrayList(Arrays.asList(TreasureKind.ONEHAND)), new ArrayList(Arrays.asList(TreasureKind.ONEHAND)));
        prize = new Prize(4, 1);
        ...
        //unusedMonsters[9] 
        badConsequence = new DeathBadConsequence("Estos unusedMonsters resultan bastante superficiales y te aburren mortalmente. Estas muerto");
        prize = new Prize(2, 1);
    ...
    public String toString(){
        String mensaje = "\nTesoros sin usar: "+ unusedTreasures.toString();
        mensaje += "\nTesoros usados: "+ usedTreasures.toString();
        mensaje += "\nMonstruos sin usar: "+ unusedMonsters.toString();
        mensaje += "\nMonstruos usados: "+ usedMonsters.toString();
        mensaje += "\nCultistas usados: "+ usedCultists.toString();
        mensaje += "\nCultistas sin usar: "+unusedCultists.toString();
